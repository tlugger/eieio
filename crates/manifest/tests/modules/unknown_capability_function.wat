(module
  ;; Rejected: eio:gpio has no such function (4.3, 7.4).
  (import "eio:gpio" "gpio_frobnicate" (func (param i32) (result i32)))
  ...
  (func (export "eio_process_signals") (param i32 i32 i32) (result i32)
    i32.const 0)
  (@custom "eio:manifest" "{\"name\":\"probe\",\"version\":\"1.0.0\",\"abi\":{\"major\":1,\"minor\":0},\"capabilities\":[\"gpio\"],\"inputs\":[{\"name\":\"in\"}]}")
)
