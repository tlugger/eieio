(module
  ;; Rejected: eio_on_timer takes a timer_id (4.2).
  ...
  (func (export "eio_process_signals") (param i32 i32 i32) (result i32)
    i32.const 0)
  (func (export "eio_on_timer") (result i32)
    i32.const 0)
  (@custom "eio:manifest" "{\"name\":\"probe\",\"version\":\"1.0.0\",\"abi\":{\"major\":1,\"minor\":0},\"capabilities\":[\"timer\"],\"inputs\":[{\"name\":\"in\"}]}")
)
