...
//! return, which this milestone does not build: wasm3 meets none of LEAF §4.5's requirements
//! on an engine binding, having no interruption entry point at all. [`pump`] decides something else entirely: when the *next* callback
