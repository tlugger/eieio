...
# passes. Each epic appends its own crate as it lands: eio-expr (eieio-s85),
# eio-manifest (eieio-m7o), eio-host-core (eieio-35h), eio-sdk (eieio-7d8).
nostd_crates := "eio-signal"
